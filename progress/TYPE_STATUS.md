...
## Latest evidence
`T021-r1-no-scope-creep-contradiction-review.md` checks newer authorization/tenant systems work against the active drawing gate. It finds no evidence that justifies expanding R1: only `I/l/1` and candidate-B `0` slash refinement remain mutable; kerning stays OFF; widths, sidebearings and unrelated glyphs stay frozen. New systems strings use mature fallback rather than forcing provisional custom metrics.
...
3. Critique ambiguity + existing operational corpus at 14/17/24px; do not expand corpus merely because systems studies add terminology.
...
## Cross-domain state
W049/CD055 must use mature fallback and preserve full context strings; C049 cannot repair glyph ambiguity; L040 must not freeze provisional metrics.

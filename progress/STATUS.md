...
| Color / luminance / contrast | CRITIQUE | `research/008-color-luminance-contrast-hierarchy.md`; `research/010-color-science-colorimetry-foundations.md`; `research/011-lms-cone-fundamentals-observer-models.md`; `research/012-chromatic-adaptation-white-points.md`; `research/013-perceptual-color-spaces-difference.md`; `product-design/exercises/005-color-luminance-cross-context-practice.md`; `product-design/exercises/009-color-nontext-focus-proof.svg`; `product-design/exercises/009-color-nontext-focus-proof-critique.md`; `product-design/exercises/010-srgb-linear-xyz-practice.md`; `product-design/exercises/012-d65-d50-bradford-practice.md`; `product-design/exercises/013-perceptual-difference-comparison.md`; cross-context grayscale/state critique, representative text probes, measured non-text boundary, focus geometry, primary-source colorimetry foundation, encoded-sRGB → linear-light → XYZ bridge, LMS/observer-model foundation, D65↔D50 chromatic-adaptation practice, CIELAB/CIELCh/CIEDE2000 scope study, and Oklab/OkLCh comparative practice complete; official spectral integration/observer comparison, gamut-mapping practice, ICC-tool validation, and physical-display bright/low-light/interactive-focus validation pending |
...
2. build HSL vs CIELCh vs OkLCh equal-step ramps, then force high-chroma OkLCh outside sRGB to compare clipping with controlled chroma-reduction gamut mapping;

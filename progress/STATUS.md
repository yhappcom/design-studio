...
1. execute Study 010 colorimetry practice: spectral integration → CIE 1931 XYZ/xy, scale/chromaticity check, and encoded-sRGB → linear-RGB → XYZ bridge;

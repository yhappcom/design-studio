...
- Those specialist status files are synchronized to 2026-09-19. After the completed contradiction audit, the current Integration-Principle inputs are T073 / C104 / I091+L095 / W104 / CD110. Their predecessor studies T072 / C103 / I090+L094 / W103 / CD109 remain the audited foundation.
...
| E51 | LogMate product-authored UI is English-only. Device language does not translate UI copy; locale affects numeric date ordering/presentation only. | CANONICAL PRODUCT | MASTER §8; ui-contract Language/Locale; D-007 | This does not constrain user/source text. Remark must be treated as arbitrary-language Unicode/free text rather than English UI copy. | CONFIRMED / OWNER CLARIFIED 2026-09-19 |
| E52 | Home Activity period semantics remain 7 / 28 / 90 days + Custom. Current visual work may keep labels as `7 days / 28 days / 90 days / Custom`; whether a shared `Last` prefix returns is deferred to later copy/detail refinement. | OWNER CLARIFICATION 2026-09-19 | current owner direction; historical MASTER/ui-contract/D-009 wording | Do not spend current concept work forcing `Last` into each segment. Preserve the period meaning; exact prefix realization is not a current synthesis invariant. | CONFIRMED SEMANTICS / COPY DETAIL OPEN |
| E53 | Whole-app navigation architecture remains NAV-001 OPEN, but the owner prefers the next Home concept to include a bottom-navigation region because available Home space permits it. | PRODUCT OPEN + OWNER EXPLORATION DIRECTION 2026-09-19 | MASTER NAV-001; current owner direction | Include bottom navigation as the preferred Home concept exploration default without treating its destinations, persistence, or whole-app architecture as product-final. | SCOPED / NAV-001 OPEN |
...
| E59 | T072/L094/CD109 EN/KO or localization stress references are specialist stress methodology, not LogMate product-language authority. | EVIDENCE-SCOPE RECONCILIATION | T072; L094; CD109; T073; CD110; MASTER §8; ui-contract | For LogMate UI fixtures use English product copy, canonical numeric date locale formats, and Unicode/source-data stress for source/user content. Remark specifically must tolerate arbitrary language/script. | RESOLVED SCOPE |
| E60 | The Home snapshot's historical `no bottom navigation implied by this candidate` is superseded for the next visual exploration by the owner's preference to include a bottom-navigation region. | OWNER EXPLORATION DIRECTION / PRODUCT OPEN | Home snapshot; current owner direction; MASTER NAV-001 | Next Home concept should make room for bottom navigation; this still does not promote a final app-wide IA or final nav destinations. | SCOPED / CURRENT EXPLORATION |
| E61 | Current specialist Integration-Principle inputs are T073 / C104 / I091+L095 / W104 / CD110 as recorded by the 2026-09-19 specialist status files. | STUDIO GOVERNANCE / EVIDENCE PROVENANCE | AGENTS; specialist status files; T073/C104/I091/L095/W104/CD110 | Their predecessor synthesis studies remain the audited foundation. None outranks later owner/canonical product decisions. | CONFIRMED PROVENANCE |
...
- Activity: period semantics are 7 / 28 / 90 days + Custom; current labels may omit `Last`, with any shared-prefix treatment deferred.
- Navigation: next Home concept should explore a bottom-navigation region as owner-preferred composition; whole-app navigation architecture remains NAV-001 OPEN.
...
8. NAV-001 — whole-app navigation architecture remains open. Bottom navigation is now an owner-preferred Home concept input, not a final global navigation contract.

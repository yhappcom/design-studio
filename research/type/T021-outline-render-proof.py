...
def ellipse(p,x0,y0,x1,y1,inner=False):
 # Cubic circle approximation is converted through Cu2QuPen before writing glyf.
...
def new_curve_pen():
 tt=TTGlyphPen(None)
 return tt, Cu2QuPen(tt, max_err=1.0, reverse_direction=False)
def glyph_H(d):
...
results={'upm':UPM,'kerning':False,'sizes_px':[14,17,24],'strings':STRINGS,'hypotheses':HYP,'notes':['Custom research outlines generated for H/O/n/o.','Cubic construction curves are converted to quadratic TrueType outlines through Cu2QuPen.','A/B/C differ in stem and sidebearing/advance hypotheses.','Raster proof uses Pillow FreeType; no browser/native/human claim.']}

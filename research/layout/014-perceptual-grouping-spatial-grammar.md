# Study 014 — Perceptual Grouping as Spatial Grammar
...
This study extends `research/layout/006-grid-composition-hierarchy.md`. Study 006 establishes grid and alignment as relationship systems. This study moves one level earlier: **before a grid can organize a screen, the visual system must decide what belongs together, what is separate, and which regions form perceptual units.**
...
The paired Exercise 014 must demonstrate:

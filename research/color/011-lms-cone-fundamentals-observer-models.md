...
This study follows `research/color/010-color-science-colorimetry-foundations.md`. Study 010 established the chain from spectral stimulus to standardized tristimulus values. Study 011 goes one level deeper into the observer model.
